...
<form method="post" action="/lot3-statistics" enctype="multipart/form-data" style="margin-left: 5px; margin-top: 30px">
                    {{ csrf_field() }}
                    ...
                    <button type="submit" class="btn btn-red-blue-lite form-group" title="Result" value="Submit"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Result</font></font></button>
                </form>
                ...
                <div style="margin:0 auto; width:100%;">
                       ...
                       ?>
                        <tr>
                          <?php
                            if($value>1){
                           ?>
                            <td class="td_style">{{$key}}</td> <td class="td_style">{{$value}}</td> 
                          <?php } ?>
                        </tr>
                      <?php } ?>
                  </table>
                  <table class="table_style" style="margin-left: -11px;">
                    ...
                    <?php 
                      foreach ($lot3 as $keys => $values) {
                       ?>
                        <tr>
                          <?php
                            if($values>1){
                           ?>
                            <td class="td_style">{{$keys}}</td> <td class="td_style">{{$values}}</td> 
                          <?php } ?>
                        </tr>
                      <?php } ?>
                  </table>
                  <table class="table_style" style="margin-right:10px; margin-top: 10px">
                    ...
                    <tr>
                      <td class="td_style">
                        <?php 
                        foreach ($digitNotApearInSpecialLot3 as $digitNotApearSpecialLot3) {
                         ?>
                          {{$digitNotApearSpecialLot3}},
                        <?php } ?>
                      </td>
                    </tr>
                  </table>
                  <table class="table_style" style="margin-left: -11px; margin-top: 10px">
                    ...
                    <tr>
                      <td class="td_style">
                        <?php 
                        foreach ($digitNotApearInLot3 as $digitNotApearLot3) {
                         ?>
                          {{$digitNotApearLot3}},
                        <?php } ?>
                      </td>
