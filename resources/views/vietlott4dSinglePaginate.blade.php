    ...
    <div class="row block-messeage">
        <div class="col-xs-6">
            <div class="border-radius block-left">
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">You have </font>
                </font><span class="text-blue-bold" id="txtLotteryName"><font style="vertical-align: inherit;">

                <font style="vertical-align: inherit;">Northern Lottery</font></font></span>

                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> results. </font>

                <span id="txtnumberdigits">{{ $result_count }}</span>

                <font style="vertical-align: inherit;"> digit </font></font>

                <br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                    ticket type </font><font style="vertical-align: inherit;">, {{ $selected_chon }} </font><font style="vertical-align: inherit;">draw 
                     </font><font style="vertical-align: inherit;">on 
                     </font>
                     <span id="txtDayPrize">{{$selected_date->toDateTime()->format('d-m-Y')}}</span>

                    <font style="vertical-align: inherit;"> 
                    number range is: </font>
                    <b><span class="text-red" id="txtYourLoto">{{$selected_number}}</span></b>

                </font><span id="txtnumberdigits"><font style="vertical-align: inherit;"></font></span><font style="vertical-align: inherit;"></font><span id="txtDayPrize"><font style="vertical-align: inherit;"></font></span>
        ...
        <div class="col-xs-6" id="divtrungso">
            <div class="border-radius block-right">
                <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Sorry your lottery ticket did not win. </font></font>
                <br><b><span class="text-red"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Wish you luck next time !!!</font></font></span></b></div>
        </div>
    </div>
</div>
