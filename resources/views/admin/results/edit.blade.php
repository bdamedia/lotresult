                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="post" enctype="multipart/form-data"
                              action="/admin/results/{{ $data->id }}/edit" role="form" autocomplete="off">
                            @csrf

                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Result Date</label>
                                <div class="col-lg-9">
                                    <input class="form-control" datetimeformat="dd/MM/y, HH:mm" name="date"
                                           value="{{ $data->result_day_time->toDateTime()->format('Y-m-d') }}"
                                           type="date">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select class="region" name="region">
                                        ...
                                        @foreach($region as $val)
                                            <option
                                                @php if($data->lottery_region == $val->lottery_region ){ echo "selected"; } @endphp value="{{ $val->lottery_region }}">{{ $val->lottery_region }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select class="company" name="company">
                                        @foreach($res as $val1)
                                            ...
                                            <option
                                                @php  if($data->lottery_company == str_replace('Xổ Số','XS',$val1->lottery_company_name)){ echo "selected"; } @endphp value="{{ $val1->lottery_company }}">{{ $val1->lottery_company_names }}</option>

                                            @php
                                                }else{
                                            @endphp
                                            <option
                                                @php  if(strtoupper($data->lottery_company) == strtoupper($val1->lottery_company)){ echo "selected"; } @endphp value="{{ $val1->lottery_company }}">{{ $val1->lottery_company_names }}</option>
                                            @php
                                                }
                            ...
                            <div class="form-group row">
                                ...
                                if(is_array((array) $p1) && count((array)$p1) > 0){
                                  ...
                                  //  $a = $p1v;
                                    ...
                                    <input type="text" id="prize-1" name="prize-1" data-role="tagsinput"
                                           value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-2" name="prize-2"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-3" name="prize-3"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-4" name="prize-4"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            @php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-5" name="prize-5"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-6" name="prize-6"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-7" name="prize-7"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="inputTage" id="prize-8" name="prize-8"
                                           data-role="tagsinput" value="{{ $a }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" id="prize-9" name="prize-9" data-role="tagsinput"
                                           value="{{ $a }}">
                                </div>
                            </div>
                                @php } @endphp
