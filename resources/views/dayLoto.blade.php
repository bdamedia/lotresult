...
$gh = count($content[$key]);
          ...
          $th .= '<th class="text-center"><a href="/ket-qua-xsmt/kq'.$region.'-'.getCompanySlug($lot["lottery_company"]).'" title="Xổ số '.$lot["lottery_company"].'">'. getCompanyName($lot["lottery_company"]).'</a></th>';
                                      }elseif ($lot["lottery_region"] == 'XSMN'){
      $title = "Xổ số miền Nam";
          $th .= '<th class="text-center"><a href="/ket-qua-xsmn/kq'.$region.'-'.getCompanySlug($lot["lottery_company"]).'" title="Xổ số '.$lot["lottery_company"].'">'. getCompanyName($lot["lottery_company"]).'</a></th>';
                                      }else{
